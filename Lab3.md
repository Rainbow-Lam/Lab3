...
``` r
lab3data <- read.csv("/Users/rainbow/Documents/GitHub/Lab3/lab3data.csv")
```
...
Descriptively, males have a higher self-esteem while females have a
slightly higher satisfaction with life. The relationship between
self-esteem and life satisfaction is stronger for males compared to
females.
